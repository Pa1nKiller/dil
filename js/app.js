(() => {
    ...
    function rangeInit() {
        ...
        function setPriceValues() {
            ...
            range.noUiSlider.set([ priceStartValue, priceEndValue ]);
        }
    ...
    function initSliders() {
        if (document.querySelector(".swiper__product")) {
            var swiper = new swiper_core_Swiper(".swiper_thumbnail-product", {
                spaceBetween: 10,
                slidesPerView: 3,
                freeMode: true,
                watchSlidesProgress: true,
            ...
            new swiper_core_Swiper(".swiper__product", {
    ...
    document.getElementById("submitButton").addEventListener("click", (function(e) {
        ...
        cars.forEach((car => {
            let priceStr = car.querySelector(".car__price").querySelector("span").innerHTML;
            let index = priceStr.indexOf("р");
            let price = priceStr.substring(0, index);
            price = price.replace(/\s/g, "");
            price = Number(price);
            let min = Number(document.querySelector("#min").value);
            let max = Number(document.querySelector("#max").value);
            if (car.getAttribute("data-filter-name") !== select || price < min || price > max) car.style.display = "none"; else car.style.display = "flex";
        }));
    }));
})();